...
In contrast, keratocyte, a fish epidermal cell, migrates while maintaining its half-moon shape.
Hence, the migration does not occur without causing shape change.
However, keratocytes move forward without changing its shape. It is not clear why keratocytes form a half-moon shape, and migrate without changing its shape.
